...
**Branch-Specific Feature Plans** → `docs/plans/v[X.Y]_[feature-name]_plan.md`
...
**Ad Hoc/Exploratory Plans** → `.claude/plans/[random-name].md`
...
│         - docs/plans/v5.0_authentication_plan.md
│
...
**Action Required:**
- Mark as "✅ Complete" in ROADMAP when finished
...
### ❌ Mistake 1: Leaving Plans in `.claude/plans/` for Branch Features
...
### ❌ Mistake 2: Committing `.claude/plans/` Files
...
### ❌ Mistake 4: Not Referencing Plans in ROADMAP
...
### ❌ Mistake 5: Deleting Plans After Implementation
...
|-----------|----------|-------------|-----------|--------|
| Feature Branch | `docs/plans/` | ✅ Yes | Permanent | `v[X.Y]_[feature]_plan.md` |
| Ad Hoc Investigation | `.claude/plans/` | ❌ No | Temporary | Auto-generated |
| Bug Fix | `.claude/plans/` | ❌ No | Temporary | Auto-generated |
| Exploration | `.claude/plans/` | ❌ No | Temporary | Auto-generated |
