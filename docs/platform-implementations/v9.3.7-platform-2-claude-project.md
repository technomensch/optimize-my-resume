...
Before finalizing your bullets, use the **[User-Friendly Verification Checklist](../../docs/checklists/bullet-verification-checklist.md)** for manual spot-checks:
- Budget allocation and word count (350-500 words)
- Position headers with dates
- Bullet formatting and verb diversity
- Metric preservation and character limits
- Final reconciliation checks

This checklist complements the automated validator and helps catch issues before submission.
