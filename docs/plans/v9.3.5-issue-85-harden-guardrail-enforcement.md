...
### Phase 4: Gold Master Persistence 🔴
- [x] **Task 4.1:** Verify `<final_recency_anchor>` in `PROJECT-INSTRUCTIONS.md`
  - ✅ Anchor confirmed at absolute bottom of file (v9.3.4 -> v9.3.5 logic sync).
  - ✅ Verified constraints: Terminology, Header Format, ASCII Visuals, EOF String.
