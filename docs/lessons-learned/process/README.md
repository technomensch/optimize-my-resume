...
### 1. [Patch Workflow and /patch Command](Lessons_Learned_Patch_Workflow.md)
**Date:** 2025-12-11
...
### 2. [Branch Prompt Workflow Pattern](Lessons_Learned_Branch_Prompt_Workflow.md)
**Date:** 2025-12-10
...
### 3. [Chat History Export Workflow](Lessons_Learned_Chat_History_Workflow.md)
**Date:** 2025-12-18
...
### 4. [Plan File Locations](Lessons_Learned_Plan_File_Locations.md)
**Date:** 2025-12-10
...
### 5. [Automated Validation for Documentation Consistency](Lessons_Learned_Automated_Validation.md)
**Date:** 2025-12-10
...
### 6. [Version Consistency Across Split Changelogs](Lessons_Learned_Split_Changelog_Versioning.md)
**Date:** 2025-12-17
...
**Automation:**
- Automated Validation and Split Changelog show value of scripts catching errors
- Reducing manual checking burden
